...
class NordVPNProxyProvider extends AuthenticatedProxyProvider with ProxyProviderClientMixin {
  ...
  Future<void> _cacheCountryCodes() async {
    ...
    _cachedCountryCodes = {
      for (final countryListing in countriesJson) countryListing['code']: countryListing['id'],
    };
  }
