...
class VpnUnlimitedProxyProvider extends AuthenticatedProxyProvider with ProxyProviderClientMixin {
  ...
  static final _apiUri = Uri(scheme: 'https', host: 'api.vpnunlimitedapp.com', path: 'api/v1');

  @override
  String get userAgent => 'Dalvik/2.1.0 (Linux; U; Android 11; Pixel 4 XL Build/RP1A.200720.009)';
