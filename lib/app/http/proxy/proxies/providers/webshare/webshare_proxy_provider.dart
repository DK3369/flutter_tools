...
class WebshareProxyProvider extends ProxyProvider with ProxyProviderClientMixin {
  ...
  Future<Proxy> getProxy() async =>
      (await getProxies()).firstWhere((webshareProxy) => webshareProxy.isValid).toProxy();
    ...
    try {
      ...
      switch (prioritization) {
        ...
        case WebshareProxyPrioritization.highestCountryCodeConfidence:
          proxies.sort(
            (a, b) => a.countryCodeConfidence.compareTo(b.countryCodeConfidence),
          );
          break;
      }
