...
import '../proxies/proxy_provider.dart';
...
class Proxy {
  ...
  String get configuration {
    assert(!(host.contains('@') || host.contains(':')), 'Host contains invalid characters!');
  ...
  IOClient createIOClient([HttpClient? existingHttpClient]) {
    ...
    final httpClient = (existingHttpClient ?? HttpClient())..findProxy = (uri) => findProxyString;
