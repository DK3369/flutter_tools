...
class _HomePageState extends State<HomePage> {
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    if (!kIsWeb && Platform.isAndroid) ...<Widget>[
                      ...
                      PaddedElevatedButton(
                        buttonText: 'Show notification with number if the launcher supports',
                        onPressed: () async {
  ...
  Future<void> _showNotificationWithNoTitle() async {
    ...
    await flutterLocalNotificationsPlugin.show(0, null, 'plain body', platformChannelSpecifics,
        payload: 'item x');
  }
  ...
  Future<void> _showBigPictureNotification() async {
    final String largeIconPath =
        await _downloadAndSaveFile('https://via.placeholder.com/48x48', 'largeIcon');
    final String bigPicturePath =
        await _downloadAndSaveFile('https://via.placeholder.com/400x800', 'bigPicture');
  ...
  Future<void> _repeatNotification() async {
    ...
    const NotificationDetails platformChannelSpecifics =
        NotificationDetails(android: androidPlatformChannelSpecifics);
    await flutterLocalNotificationsPlugin.periodicallyShow(0, 'repeating title', 'repeating body',
  ...
  Future<void> _showProgressNotification() async {
    ...
    for (int i = 0; i <= maxProgress; i++) {
      await Future<void>.delayed(const Duration(seconds: 1), () async {
        ...
        final NotificationDetails platformChannelSpecifics =
            NotificationDetails(android: androidPlatformChannelSpecifics);
        await flutterLocalNotificationsPlugin.show(0, 'progress notification title',
  ...
  Future<void> _showNotificationWithSubtitle() async {
    ...
    await flutterLocalNotificationsPlugin.show(0, 'title of notification with a subtitle',
  ...
  Future<void> _showNotificationWithAttachment() async {
    ...
    final NotificationDetails notificationDetails =
        NotificationDetails(iOS: iOSPlatformChannelSpecifics, macOS: macOSPlatformChannelSpecifics);
    await flutterLocalNotificationsPlugin.show(0, 'notification with attachment title',
  ...
  Future<Widget> _getActiveNotificationsDialogContent() async {
    ...
    if (!(androidInfo.version.sdkInt! >= 23)) {
      ...
      return const Text(
        '"getActiveNotifications" is available only for Android 6.0 or newer 3321',
      );
    }
